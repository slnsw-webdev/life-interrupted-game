...
games[0][0] = ["How does England try to guard against the Zeps?",
...
games[0][1] = ["By means of patrols on the coast, anti-aircraft guns, and searchlights",
		"The Iron Cross",
		"1/- a day to 5/-",
...
games[1][0] = ["Have the Germans a large army in time of peace?",
		...
		"What is shrapnel?",
		"How do the Germans charge in an attack?", 
...
games[1][1] = ["Yes, every man has to be trained as a soldier.",
...
games[2][0] = ["Who is Lord Kitchener, and what was his work?",
		"What is Krupps?",
		"What is a sniper?",
...
games[2][1] = ["Secretary of State for War from August, 1914, to June, 1916. To raise and train men for the Army",
...
games[3][0] = ["How are orders given on the battle field?",
		"Who was the first New Zealand to gain a V.C.?",
...
games[3][1] = ["By signals, telephones, notes and word of mouth",
		"Corporal Bassett. Won on Gallipoli",
...
games[4][0] = ["What is the fate of spies when caught?",
...
games[4][1] = ["They are court martialled and shot",
...
games[5][0] = ["What is the Triple Entente?",
...
games[5][1] = ["An agreement between England, France, and Russia to help one another",
		"About six months",
...
games[6][1] = ["Scouts to guard against unexpected attached by the enemy",
		"In peace time about two years",
...
games[7][0] = ["What two great countries began the Great European War?",
...
games[7][1] = ["Austria made war on Serbia",
...
games[8][0] = ["Why was it thought necessary to send Armies to Gallipoli?",
...
games[8][1] = ["To fight on land and help warships to open the way to Constantinople",
...
games[9][0] = ["What is a Trench Periscope?",
		"Why was it necessary to withdraw the troops from Gallipoli?",
		"Why is the military band taken with a regiment?", 
...
games[9][1] = ["An instrument used for watching the enemy from the trenches without exposing the user",
		"The Turks were too strongly entrenched",
		"To cheer the men, and to help them to keep time when marching",
...
games[10][0] = ["What are the meanings of D.S.O. and D.C.M.?",
		"What are the regular Army rations on Active Service?",
...
games[10][1] = ["The Distinguished Service Order given to officers. Distinguished Conduct Medal given to men",
		"Bully beef and biscuits",
...
games[11][0] = ["When, and how, do the Germans make air raids?",
...
games[11][1] = ["On clear, dark nights they drop bombs from Zeppelins",
...
games[12][0] = ["What are the non-commissioned officers?",
		"What was the size of the Main Expeditionary Force that left New Zealand?",
		"Why were the Australian and New Zealanders sent to Gallipoli and who was in command of them?",
		"How has Britain raised her army?", 
		"Why is practice in bomb throwing necessary?",
...
games[12][1] = ["All the officers below the rank of Second Lieutenant",
		"About 9000 men",
		"Because they were the most suitable men for the work. General Birdwood",
		"First by voluntary enlistments and then by conscription",
		"If bombs are thrown too soon the enemy have time to throw them back before they explode",
...
games[13][0] = ["How are the needs of the soldiers supplied?",
		"What are prize-ships?",
...
games[13][1] = ["By the Army Service Corps",
		"Enemy ships that have been captured",
...
games[14][0] = ["Did the Germans expect Belgium to fight?",
		"What are Soup Kitchens?",
...
games[14][1] = ["No, they thought the Belgians would let them march straight through to Paris",
		"Kitchens a few miles behind the firing line, where troops returning to the trenches can get hot soup",
...
games[15][0] = ["What was the famous British Retreat at the beginning of the war?",
		"What was the average weight of a soldier's kit?",
		"Why did England want to take Constantinople from the Turks?",
		"What large towns have been destroyed in Belgium by the Germans?",
		"Has the war affected neutral countries?",
...
games[15][1] = ["The retreat from Mons",
		"About 56 lbs. (approx.. 25.4kgs)",
		"To allow Russia to export her wheat",
		"Louvain, Namur, Mons. Brussels, and Antwerp",
		"Yes, America has lost many citizens and ships by submarines",
...
function gameStart(gameRef) {
  ...
  // set the id on the reset button
  ...
  for ( var i=0; i < 12; i++ ) {
    $('<div><span class="inner-content">' + answers[anumbers[i]] + '</span></div>').data( 'number', anumbers[i] ).attr( 'id', 'card'+anumbers[i] ).appendTo( '#cardAnswers' ).draggable( {
      containment: '#card-content-container',
  ...
  for ( var i=0; i < 12; i++ ) {
    $('<div><span class="inner-content">' + questions[qnumbers[i]]  + '</span></div>').data( 'number', qnumbers[i] ).appendTo( '#cardQuestions' ).droppable( {
      accept: '#cardAnswers div',
      hoverClass: 'hovered',
      drop: handleCardDrop
    });
  }
  ...
  function handleCardDrop( event, ui ) {
	  ...
	  var answerNumber = ui.draggable.data( 'number' );
	  ...
	  if ( movedCards == 12 ) {
		$('#game-message-container').empty();
		$('#game-message-container').append("<p>Well done you scored " + correctCards + " out of 12. Would you like to play again?</p>");
		$('#game-message-container').append("<input type='button' id='menu-home' class='menu-btn' value='Home'><input type='button' id='menu-reset' class='menu-btn' value='Play again'>");  
	    $('#game-message').css("visibility", "visible");
	  }	
	}
